...
<body>
	<div style="height: 100%; justify-content: center; display: flex;">
		<form action="SalvarMateriaServlet" method="post" 
				...
				<input type="text" name="nome" style="width: 100%" value="<%= materia.getNome() %>">
				
				<br /><br />
				
				<label style="color: #009a84">Nome do Professor: </label> <br />
				<input type="text" name="nome_prof" style="width: 100%" value="<%= materia.getNomeProfessor() %>">
							
				<br /><br /><br />
				
				<label style="color: #009a84">carga horaria:  </label> <br />
				<input type="text" name="carga_horaria" style="width: 100%" value="<%= materia.getCargaHoraria() %>">	
			...
			<script src="scripts/validadorMateriaEditar.js"></script>
		</div>
</body>
</html>